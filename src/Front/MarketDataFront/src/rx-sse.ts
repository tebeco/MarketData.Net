...
//  */
// export function fromEventSource(source: sse.IEventSourceStatic, event: string, openObserver: rx.Observer<sse.IOnMessageEvent> = undefined): rx.Observable<sse.IOnMessageEvent> {

//     return rx.Observable.create(function (observer: rx.Observer<sse.IOnMessageEvent>) {
//         function onOpen(e: sse.IOnMessageEvent) {
//             openObserver.next(e);
...
//         function onMessage(e: sse.IOnMessageEvent) {
//             observer.next(e);
//         }

//         openObserver && source.addEventListener('open', onOpen);
